...
En recherche d'alternance Développeur FullStack et IA Agentique pour 2027.

## Ce que je construis

- [Journal de POCs](https://adamzou.fr/pocs) : mes proof of concepts, documentés parce que le raisonnement compte autant que la solution
- [PeerCheck](https://peercheck.adamzou.fr) : code review IA pour les étudiants Holberton (Node.js, SSE, Claude API)
- [Agentic pour les débutants](https://github.com/Adamzou-lab/agentic-pour-les-debutants) : cours en français pour apprendre à construire des agents IA en Python
- [Holberton Cheatsheets](https://cheatsheets.adamzou.fr) : fiches de révision gaming-style
- [AZ QCM](https://qcm.adamzou.fr) : QCM mobile-first pour réviser les quiz Holberton
